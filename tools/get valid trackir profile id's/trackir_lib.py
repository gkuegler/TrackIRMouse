...
class TrackIRDLL():
    ...
    def start(self):
        ...
        """
        print("NP_GetSignature says:")
        sig = self.NP_GetSignature()
        print("------------------")
        print(sig.AppSignature)
        print(sig.DllSignature)
        print("------------------")
        print()
        print("Calling NP_RegisterWindowHandle")
        self.NP_RegisterWindowHandle(self.hWnd)
        print("Calling NP_RequestData")
        self.NP_RequestData(119) # Request roll,pitch,yaw and x,y,z
        print("Calling NP_RegisterProgramProfileID")
        self.NP_RegisterProgramProfileID(self.trackir_profile_id)
        print("Calling NP_StartDataTransmission")
        self.NP_StartDataTransmission()
    
    def stop(self):
        """ We no longer want to call NP_RequestData """
        print("Calling NP_StopDataTransmission")
        # self.NP_StopDataTransmission()
        print("Calling NP_UnregisterWindowHandle")
