...
//
// request version information using 2 messages, they cannot be expected to arrive in a specific order - so always parse
// using the High byte the messages have a NPCONTROL byte in the first parameter, and the second parameter has packed
// bytes.
//   Message 1) (first parameter)NPCONTROL : (second parameter) (High Byte)NPVERSIONMAJOR (Low Byte) major version
//   number data Message 2) (first parameter)NPCONTROL : (second parameter) (High Byte)NPVERSIONMINOR (Low Byte) minor
//   version number data
