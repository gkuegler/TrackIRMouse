...
void WinSetup(CConfig config)
{
    ...
    {
        throw Exception(
            fmt::format("Incompatible config: {} monitors specified but {} monitors found", count, monitorCount));
    }
...
{
    static MOUSEINPUT mi = {0, 0, 0, MOUSEEVENTF_ABSOLUTE | MOUSEEVENTF_MOVE | MOUSEEVENTF_VIRTUALDESK, 0, 0};
...
void MouseMove(int monitorCount, float yaw, float pitch)
{
    ...
    {
        if ((yaw > g_displays[i].rotationBound16BitLeft) && (yaw < g_displays[i].rotationBound16BitRight) &&
            (pitch < g_displays[i].rotationBound16BitTop) && (pitch > g_displays[i].rotationBound16BitBottom))
        {
    ...
    {
        x = g_displays[lastScreen].boundAbsLeft + g_displays[lastScreen].paddingLeft * g_xPixelAbsoluteSlope;
    }
    else if (yaw > g_displays[lastScreen].rotationBound16BitRight)
    {
        x = g_displays[lastScreen].boundAbsRight - g_displays[lastScreen].paddingRight * g_xPixelAbsoluteSlope;
    }
    else
    {
    ...
    {
        y = g_displays[lastScreen].boundAbsTop + g_displays[lastScreen].paddingTop * g_yPixelAbsoluteSlope;
    }
    else if (pitch < g_displays[lastScreen].rotationBound16BitBottom)
    {
        y = g_displays[lastScreen].boundAbsBottom - g_displays[lastScreen].paddingBottom * g_yPixelAbsoluteSlope;
    }
    else
    {
