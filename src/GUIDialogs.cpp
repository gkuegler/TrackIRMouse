...
cSettingsAdvancedlPanel::cSettingsAdvancedlPanel(wxWindow* parent, SData* pUserData)
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize,
        wxTAB_TRAVERSAL, "") {
    m_pUserData = pUserData;
    ...
    m_txtTrackIrDllPath =
        new wxTextCtrl(this, myID_TRACK_IR_DLL_PATH, pUserData->trackIrDllFolder, wxDefaultPosition,
